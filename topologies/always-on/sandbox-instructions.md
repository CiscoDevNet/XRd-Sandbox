...
- ✅ Your sandbox reservation credentials (provided after reservation)
...
Use the credentials provided in your sandbox reservation email to connect to the XRd devices.
